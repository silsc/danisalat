...
<body>
    ...
    <div id="servicios" class="section">
        ...
        <div class="servicios-container">
            <div class="servicios-produccion">
              ...
              <h4>Producción</h4>
              <p>Al hacer música es difícil expresar emociones y a la vez ser objetivos. Mi trabajo es definir una <span>visión única</span> para cada banda y tomar las decisiones difíciles, musicales y de sonido, para que el proyecto sea un <span>éxito</span>.
              <br>Es fácil pasar desapercibido en Spotify. <span>Si crees en tu música, merece ser escuchada</span>.
              </p>
            </div>
            <div class="servicios-mezcla">
              ...
              <h4>Mezcla</h4>
              <p>Las producciones DIY corren el riesgo de sonar a maqueta. Creo que los músicos tienen que saber autoproducirse y <span>tener una visión</span>, pero es difícil conseguir resultados, y necesitas alguien que sepa cómo darle <span>impacto y energía</span> al sonido.
              <br>Si no has empezado aún, puedo aconsejarte durante el proceso para tomar <span>las mejores decisiones</span>.
              </p>
            </div>
        </div>
    </div>
    ...
    <div id="trabajo" class="section">
        ...
        <div class="spotify">
          ...
          <p><a href="#contacto">Vamos a hablar</a><br> o escucha <a href="https://open.spotify.com/playlist/2nwVcowWfYhXXqkmVgGVNK?si=586a412f544a44e7" target="_blank">mi playlist en Spotify</a></p>
        </div>
    </div>
      ...
      <div class="wrapper">
        <div class="contact-info">
          ...
          <div class="contact-sns">
            <a href="https://www.youtube.com/channel/UCS13MmmbbiE4PmsZVURWVrQ" target="_blank">
